...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      const userRes = await api.get(`/user/${id}/user`);

      setUser(userRes.data.details);

      const postRes = await api.get(`/post/${id}/user`);
  ...
  const updatePost = async () => {
    try {
      await api.put(`/post/${editPost._id}/post`, {
        caption,
      });
      fetchProfile();
      setEditPost(null);
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12">
                <div className="bg-[#FFF8EE] rounded-3xl p-6 hover:-translate-y-2 transition shadow-sm">
                  ...
                  <p className="text-gray-500 mt-3">
                    Build meaningful friendships and chat instantly with mutual
                    followers.
                  </p>
                </div>

                <div className="bg-[#FFF8EE] rounded-3xl p-6 hover:-translate-y-2 transition shadow-sm">
                  <h3 className="text-xl font-bold">📸 Share Moments</h3>
                ...
                <div className="bg-[#FFF8EE] rounded-3xl p-6 hover:-translate-y-2 transition shadow-sm">
                  <h3 className="text-xl font-bold">❤️ Grow Community</h3>

                  <p className="text-gray-500 mt-3">
                    Increase engagement through reactions, comments and
                    conversations.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto mt-14">
          ...
          {posts.length === 0 ? (
            <div className="bg-white rounded-3xl shadow-xl py-24 text-center">
              <h3 className="text-3xl font-bold mb-3">No Posts Yet</h3>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-[#FF7F66] hover:text-[#ff6245] font-semibold"
                      >
                        View →
                      </button>
                    </div>
