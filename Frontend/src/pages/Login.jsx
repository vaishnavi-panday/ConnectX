...
const Login = () => {
    ...
    try {
      ...
      if (error.response && error.response.data && error.response.data.errors) {
        ...
        error.response.data.errors.forEach((err) => {
          validateErrors[err.path] = err.msg;
        });
  ...
  return (
    <div className="min-h-screen bg-[#FFF8EE] overflow-hidden relative">
      <div className="pointer-events-none absolute w-[500px] h-[500px] bg-[#FFD7C8] rounded-full blur-[150px] opacity-40 -top-40 -right-40" />

      <div className="pointer-events-none absolute w-[400px] h-[400px] bg-pink-200 rounded-full blur-[150px] opacity-20 bottom-0 left-0" />
        ...
        <div className="flex flex-col justify-center px-8 md:px-16">
          <div className="mb-12">
            ...
            <p className="text-gray-500 mt-6 text-lg leading-8">
              Continue your journey and reconnect with your friends from
              anywhere.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[32px] shadow-2xl overflow-hidden w-[650px] border">
            ...
            <div className="bg-white p-8">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <div className="font-bold text-lg">Vaishnavi Panday</div>

                  <div className="text-gray-400">@vaishnavi</div>
                </div>
              </div>
              ...
              <p className="mt-6 text-gray-600 leading-8">
                Share your stories, connect with amazing people, and experience
                a social platform built with simplicity and elegance.
              </p>
            </div>
          </div>
        </div>
