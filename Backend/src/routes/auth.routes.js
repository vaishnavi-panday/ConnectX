...
router.post('/register', upload.single("profilepic"), validationMiddleware.validateUserRegistration,validationMiddleware.validateImageUpload("profilepic" , false), authController.registerUser);
